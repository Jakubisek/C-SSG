...
run_grid_tests() {
    ...
    grid_test "solvable 2 but compacted input" "030024*51030705*35008*37*940800570107009*460403*35*520307*460" sc
    grid_test "compacted empty" "*81*" xx
    grid_test "compact easy 123456789" "*6789456789*591234*77891567*434*6567345*667891*95678" sc
    grid_test "compact 123456789" "*6789056789*591234*77801567*434*6567345*667891*95" sc
